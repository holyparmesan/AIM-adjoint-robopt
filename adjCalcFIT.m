function adj_maps = adjCalcFIT(xs, ys, E12dat, E21dat, idx_x, idx_y, f, N_mode, distanceScale, varargin)
...
for i = 1:nargin-9
    ...
    for j = 1:N
        ...
        for k = 1:Nlambs
            E12paras(j,k) = fitinterp2(xsm(ryi-3:ryi+2,rxi-3:rxi+2), ysm(ryi-3:ryi+2,rxi-3:rxi+2), (E12dat(rxi-3:rxi+2,ryi-3:ryi+2,1,k,1)*cos(thetas(j)) + E12dat(rxi-3:rxi+2,ryi-3:ryi+2,1,k,2)*sin(thetas(j))).', contour(j,1), contour(j,2));
            E21paras(j,k) = fitinterp2(xsm(ryi-3:ryi+2,rxi-3:rxi+2), ysm(ryi-3:ryi+2,rxi-3:rxi+2), (E21dat(rxi-3:rxi+2,ryi-3:ryi+2,1,k,1)*cos(thetas(j)) + E21dat(rxi-3:rxi+2,ryi-3:ryi+2,1,k,2)*sin(thetas(j))).', contour(j,1), contour(j,2));
            D12perps(j,k) = fitinterp2(xsm(ryi-3:ryi+2,rxi-3:rxi+2), ysm(ryi-3:ryi+2,rxi-3:rxi+2), (D12dat(rxi-3:rxi+2,ryi-3:ryi+2,1,k,1)*sin(thetas(j)) - D12dat(rxi-3:rxi+2,ryi-3:ryi+2,1,k,2)*cos(thetas(j))).', contour(j,1), contour(j,2));
            D21perps(j,k) = fitinterp2(xsm(ryi-3:ryi+2,rxi-3:rxi+2), ysm(ryi-3:ryi+2,rxi-3:rxi+2), (D21dat(rxi-3:rxi+2,ryi-3:ryi+2,1,k,1)*sin(thetas(j)) - D21dat(rxi-3:rxi+2,ryi-3:ryi+2,1,k,2)*cos(thetas(j))).', contour(j,1), contour(j,2));
        end
    end
